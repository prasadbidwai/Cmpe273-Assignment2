...
public class StompConnection {
	...
	private BookReq bookReuqest = null;
	 ...
	 */
	public BookReq reveiveQueueMessage(Connection connection) throws Exception {
		connection.start();
		bookReuqest = new BookReq();
	 ...
	 */
	public void publishTopicMessage(Connection connection, BookShipped text) throws Exception {
		Session session = connection.createSession(false, Session.AUTO_ACKNOWLEDGE);
